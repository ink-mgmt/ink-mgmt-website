  ...
  <Layout headerLogoColor="#000" footerBgColor="#000" footerTextColor="#fff">
      ...
      <div className="about__bios-copy-wrapper">
        <div className="bio">
          ...
          <p className="bio__copy">
            ...
            industry. With nearly 20 years of experience in brand building, he
            has worked with some of the world&rsquo;s top Agencies building some
            of the world&rsquo;s top brands. His leadership and creativity has
            been recognized by the NAACP, the late Senator Joe Young Jr, as well
        ...
        <div className="bio">
          ...
          <p className="bio__copy">
            ...
            developed a supreme eye for detail, and an aesthetic that is
            defining the visual language of new. His talent has taken him to
            reputable agencies throughout the country where he&rsquo;s worked on
        ...
        <div className="bio">
          ...
          <p className="bio__copy">
            ...
            Ant (like the bug). A writer by trade, who&rsquo;s career in writing
            for brands started at the age of six when he wrote a letter to Mars
            Candy Company suggesting they create White Chocolate M&M&rsquo;s
            (their legal department got back to him and sent him free swag). A
            widely decorated creative in the advertising industry. With a wit
        ...
        <div className="bio">
          ...
          <p className="bio__copy">
            ...
            lorem sed mi, neque enim. Gravida ullamcorper duis auctor enim
            aliquet amet amet, egestas. Massa, velit erat turpis massa donec
            elit duis id.
          </p>
        </div>
      </div>
    ...
    <section className="about__formula">
      ...
      <p className="formula__copy">
        ...
        scelerisque. Leo mauris vulputate sed nulla enim vitae ultrices id.
        Lorem nec odio odio vel. Quis mi semper donec in consequat quisque
        ultricies.
      </p>
    </section>
      ...
      <div className="principles__list">
        <div className="principles__item">
          <h3 className="principles__item-heading">
            People matter. Relationships matter more.
          </h3>
        ...
        <div className="principles__item">
          <h3 className="principles__item-heading">Integrity. Always.</h3>
          <p className="principles__item-copy">
        ...
        <div className="principles__item">
          <h3 className="principles__item-heading">Keep it creative</h3>
          <p className="principles__item-copy">
        ...
        <div className="principles__item">
          <h3 className="principles__item-heading">Embrace and evolve</h3>
          <p className="principles__item-copy">
        ...
        <div className="principles__item">
          <h3 className="principles__item-heading">Talent finds talent</h3>
          <p className="principles__item-copy">
